...
public:
  ...
  auto &get_graph() { return graph_representation; }

  auto &get_pheromones() { return pheromones; }
...
void Graph<T, Container>::add_vertex() {
  order_++;
  graph_representation.push_back(
      Container<std::pair<bool, T>, std::allocator<T>>{});
}
