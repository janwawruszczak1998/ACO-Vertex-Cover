...
public:
    ...
    double get_solution_value(Container solution_){
        return static_cast<double>(solution_.size()) / static_cast<double>(solution.size());
    }

    template<typename Container>
    bool check_if_vertex_cover(Container solution_){
